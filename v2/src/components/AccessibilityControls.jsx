const AccessibilityControls = ({ lang, onToggleLang, contrastActive, onToggleContrast }) => (
  <div className="accessibility-controls">
    <button
      ...
      aria-label={`${contrastActive ? 'Disable' : 'Enable'} high contrast mode`}
      aria-pressed={contrastActive}
      onClick={onToggleContrast}
      type="button"
    >
      <svg className="icon-contrast" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
